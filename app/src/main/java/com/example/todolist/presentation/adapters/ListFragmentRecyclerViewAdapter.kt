...
class ListFragmentRecyclerViewAdapter(val viewModel: ListFragmentViewModel, val editListener: OnNoteEditListener):
    RecyclerView.Adapter<ListFragmentRecyclerViewAdapter.MyViewHolder>()  {
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(note: Note) = with(binding){
            ...
            imgBtnEdit.setOnClickListener {
                editListener.onEditNoteRequested(note)
            }
